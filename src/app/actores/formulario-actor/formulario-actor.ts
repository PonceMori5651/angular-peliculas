...
@Component({
  ...
  imports: [MatButtonModule, MatFormFieldModule, ReactiveFormsModule, RouterLink, MatInputModule, MatDatepickerModule, InputImg],
  templateUrl: './formulario-actor.html',
  styleUrl: './formulario-actor.css',
})
export class FormularioActor implements OnInit{
  ngOnInit(): void {
