...
@Component({
  ...
  imports: [MatButtonModule, MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatSelectModule, MatCheckboxModule, ListadoPeliculas],
...
export class FiltroPeliculas implements OnInit {
  ngOnInit(): void {
    ...
    this.form.valueChanges.subscribe(valores => {
      ...
      this.escribirParametrosBusquedaURL(valores as FiltroPelicula);
    })
  }
  ...
  escribirParametrosBusquedaURL(valores: FiltroPelicula) {
    let queryStrings = [];
    if(valores.titulo) {
